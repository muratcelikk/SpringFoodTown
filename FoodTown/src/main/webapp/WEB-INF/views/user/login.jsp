...
<div class="login-form">
                <form action='<s:url value="/logging"></s:url>' method="post">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input name = "upass" type="password" id="password" required="required">
                            <i class="ti-lock"></i>
                        </div>
                        ...
                        <div class="form-footer text-center margin-top-30">
                            <p class="text-muted">Don't have an account? <a href='<s:url value="/register"></s:url>'>Sign up</a></p>
                        </div>
                    </div>
                </form>
            </div>
