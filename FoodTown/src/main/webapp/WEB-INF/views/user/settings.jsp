...
<div class="login-form">
                <form action='<s:url value="/settingsInsert"></s:url>' method="post">
                    <div class="login-form-body">
                        <div class="form-gp">
                            <label for="full-name">Full Name</label>
                            <input value = "${uname}" min="8" name = "uname" type="text" id="full-name" required="required">
                            <i class="ti-user"></i>
                        </div>
                        <div class="form-gp">
                            <label for="email">Email address</label>
                            <input value = "${umail}" name = "umail" type="email" id="email" required="required">
                            <i class="ti-email"></i>
                        </div>
                        <div class="form-gp">
